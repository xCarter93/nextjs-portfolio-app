    ...
    <div className="group relative h-[400px] overflow-hidden rounded-2xl border bg-gradient-to-t from-[#242424] to-[#020202] before:absolute before:inset-0 before:bg-[url('/noise.gif')] before:opacity-5 hover:from-[#182135] hover:to-[#080808]">
      <div className="relative flex h-full flex-col">
        ...
        <div className="relative mt-auto h-[180px] w-full overflow-hidden">
          <Image
            className="m-0 h-full w-full scale-100 object-cover p-0 grayscale transition-all duration-500 ease-in-out group-hover:scale-110 group-hover:opacity-0 group-hover:grayscale-0"
            src={image}
            width={500}
            height={180}
            alt="Card image"
          />
          <Image
            className="absolute left-0 top-0 m-0 h-full w-full scale-100 object-cover p-0 opacity-0 grayscale transition-all duration-500 ease-in-out group-hover:scale-110 group-hover:opacity-100 group-hover:grayscale-0"
